! function() {
    ...
    var q = "__test_storage_support__",
        ...
        V = function(e) {
            ...
            try {
                ...
                return t.setItem(q, W), t.getItem(q) !== W ? !1 : (t.removeItem(q), !0)
            } catch (e) {
                return !1
            }
        },
    ...
    const G = e => S(e).map((e => e.map(encodeURIComponent).join("="))).join("&"),
        Y = e => function(e) {
            return e.reduce(((e, t) => {
                let [n, i] = t;
                return e[n] = i, e
    ...
    const He = (e, t) => t,
        ...
        We = je([(e, t) => qe(e, t).events.orderedIds, (e, t) => qe(e, t).events.byIds], ((e, t) => e.map((e => t[e]))))(He),
        Ve = je([qe, We], ((e, t) => ({ ...e,
            events: t
        })))(He),
    ...
    Fe.createSelector([We, e => Ge(e).id], ((e, t) => {
        ...
        var n
    })), je([(e, t) => qe(e, t).participants, Re], ((e, t) => e.map((e => t[e]))))(He);
            ...
            return e.prototype.sendHandshake = function(t) {
                ...
                return new e.Promise((function(e, a) {
                    i.parent.addEventListener("message", (function t(r) {
                        return !!Pn(r, o) && ("handshake-reply" === r.data.postmate ? (clearInterval(n), i.parent.removeEventListener("message", t, !1), i.childOrigin = r.origin, e(new On(i))) : a("Failed handshake"))
                    }), !1);
                    var c = function() {
    ...
    const Wn = "liveChatChatId";

    function Vn(e) {
        return we(gn(e, (e => Ve(e, Wn).active)), ze(1), xe((t => t ? we(gn(e, (e => Ve(e, Wn).properties.currentAgent)), he(Boolean), be((() => t)), Oe(1)) : Ce(t))))
    }

    function Rn(e, t) {
        return we(_e(e, "state_diff"), be((() => Je(e.state, "readyState"))), he((e => e === t)), Oe(1), Te)
    }
    ...
    var ti = (e, t) => {
        ...
        we(gn(e, (e => Je(e, "readyState"))), he((e => e === F)), Oe(1), xe((() => Vn(e))), he(Boolean), fe((() => {
            const {
                email: t,
                name: n
            } = Ge(e.state);
    ...
    var Pi = (e, t, n) => {
            ...
            const a = e => {
                ...
                s = () => {
                    ...
                    i.srcset && (d.srcset = S(i.srcset).map((e => {
                        let [t, n] = e;
                        return n + " " + t
                    })).join(", "));
                    const u = nt("img", d);
    ...
    function Xi(e, t, n) {
        return function(i) {
            ...
            const {
                trackerName: l
            } = t.analytics.googleAnalytics, d = !qi(n.allowedDomains, document.location.href), u = [
    ...
    function Zi(e, t) {
        const i = u((e => {
            let [t, n] = e;
            return !n
        }), S((o = t, ["name", "email"].reduce(((e, t) => (n(t, o) && (e[t] = o[t]), e)), {}))));
        var o;
        if (i) {
            const [e, t] = i;
    ...
    function io(e, t, n) {
        ...
        }(e), fe((() => no(i.on_chat_window_hidden)))), we(qn(e), fe((e => no(i.on_chat_state_changed, {
    ...
    function uo(e, t, n) {
        ...
        }))), we(Yn(e, (() => qn(e))), fe((e => a("availability_changed", {
            availability: e
                ...
                function(e, t, n) {
                    ...
                    Ot().then((t => {
                        e.call("shouldBridgeHandleAudio").then((n => {
                            n && (St.isBridgeActive = !0, e.on("add_event", (n => {
                                let {
                                    event: i
                                } = n;
                                St.isBridgeActive && (Je(e.state, "muted") || ((e, t) => "system" !== e.author && !e.properties.welcomeMessage && e.author !== t && "custom" !== e.type)(i, Ue(e.state)) && t(yt))
                            })), e.on("reaction_received", (n => {
                                let {
                                    event: i
                                } = n;
                                St.isBridgeActive && (Je(e.state, "muted") || Ue(e.state) === i.author && t(yt))
                            })))
                        }))
                    }))
                    ...
                    const t = t => yn(t, e);
                    we(gn(e, (e => e.application.readyState)), he((e => e === F)), Oe(1), fe((() => {
                        document.addEventListener("click", t)
                    }))), we(_e(e, "unbind"), fe((() => {
                        document.removeEventListener("click", t)
                    })))
                })(e))), Oi(e), "livechat" === r && ("documentPictureInPicture" in window && (e => {
                    var t;
                    return !!(null == (t = e.properties.license.bb9e5b2f1ab480e4a715977b7b1b4279) ? void 0 : t.detached_mode_enabled)
                })(o) && Ti(t, e), (e => {
                    we(gn(e, (e => Je(e).showTextSelectionTracking)), he(Boolean), Oe(1), fe((() => {
                        Eo(e)
                    })))
                })(e), (e => {
                    const {
                    ...
                    })), he((() => r && Ve(e.state, Hi).properties.ended)), Oe(1), fe((() => {
    ...
    var Mo = (e, t) => {
        ...
        Promise.all([g, "wix" === u ? Nn() : In(), et()]).then((e => {
            let [o, r, a] = e;
            if (!qi(o.allowedDomains, window.top === window ? window.location.hostname : document.referrer)) return void console.log("[LiveChat] Current domain is not added to the allowed domains. LiveChat has been disabled.");
            ...
            p.custom || a.appendChild(p.element), window.performance && "function" == typeof window.performance.mark && window.performance.mark("lc_bind_child"), Promise.all([Po(p, w, o, s, d, null, i, h), "openwidget" === i ? Promise.resolve(o.localization) : (y = {
                ...
                let [t, n] = e;
                return p.custom || Ao(p.element), Oo(t, w, p, n, o, i), we(gn(t, (e => Je(e, "readyState"))), he((e => e === F)), Oe(1), be((() => t)), De)
            })).then((e => {
    ...
    function Do() {
        et().then((e => {
            ["https://cdn.livechatinc.com/widget/static/js/configurator.lqaJ0oO_.js"].forEach((t => {
                ((e, t) => {
