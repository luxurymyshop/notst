        ...
        J(a, b, c, d, e) {
            ...
            try {
                ...
                if (!(n = p)) {
                    ...
                    for (let V = 0, Sg = k.length - 1; V <= Sg; ++V) k[V].depth = Sg - V;
                    l = q;
    ...
    function Xk(a, b) {
        ...
        b: {
            ...
            for (const [Ra, Sa] of [
                    ...
                    [h.tc, y],
                    [h.Ab, F]
                ]) Ra === !1 ? f = f.concat(Sa) : la = la.concat(Sa);h = Wk(la);f = Wk(f);h = h.slice(0);
            for (p of f)
